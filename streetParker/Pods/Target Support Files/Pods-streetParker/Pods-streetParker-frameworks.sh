...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_bcsymbolmap "${PODS_ROOT}/Mapbox-iOS-SDK/dynamic/B8CEDF0B-90B7-325D-BA23-1B44AB41FEC9.bcsymbolmap"
  install_bcsymbolmap "${PODS_ROOT}/Mapbox-iOS-SDK/dynamic/1182BB8D-8A58-30EC-8D04-5E89575ED646.bcsymbolmap"
